...
import { SelectOption, NDropdown, DropdownOption, MenuOption } from 'naive-ui'
...
<template>
  <n-dropdown :options="dropdownOptions" :render-label="renderLabel" :render-icon="renderIcon">
    <slot />
  </n-dropdown>
</template>

<style lang="scss" scoped>
// :deep(.n-dropdown-option-body__prefix--show-icon) {
//   display: none;
// }
// .dpz-popselect {
//   display: flex;
